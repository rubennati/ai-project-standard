...
holds. On any conflict about a fact, git wins.

## Start sequence

1. `project-brief.md` — what this project is for
...
An empty log stays empty. Do not keep placeholder entries alive to make the
