...
export const ui = {
  en: {
    ...
    termSectionEnglishNote: "This section is available in English only.",
    ...
    blogTitle: "Blog",
    blogDescription:
      "Signed, dated pieces that each follow one question, observation or argument all the way through.",
    blogIntro:
      "Longer pieces that follow one question all the way through. Each is signed and dated, and argues something rather than summarising it.",
    blogFeed: "RSS feed",
  ...
  de: {
    ...
    search: "Suche",
    searchPlaceholder:
      "Nach Begriff, Definition, Alias, verwandtem Begriff oder Quelle suchen",
