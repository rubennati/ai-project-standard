...
export const ui = {
  en: {
    ...
    contact: "Contact",
    legalNoticeContactIntro: "Questions about this site, its content, or a correction:",
    legalNoticeOutstanding:
      "Still to be completed: the media owner's name and postal address. Austrian law (§ 5 ECG, § 25 MedienG) requires those in addition to a contact address.",
  ...
  de: {
    ...
    legalNoticeCopy: "Dies ist das Impressum der AI-Standard-Website.",
    contact: "Kontakt",
    legalNoticeContactIntro: "Fragen zur Website, zu Inhalten oder Korrekturwünsche:",
    legalNoticeOutstanding:
      "Noch zu ergänzen: Name und Anschrift des Medieninhabers. Diese sind nach § 5 ECG und § 25 MedienG zusätzlich zur Kontaktadresse verpflichtend.",
