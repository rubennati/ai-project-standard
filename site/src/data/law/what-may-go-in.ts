  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "If the vendor processes the data on your instructions, they are a processor, and Art. 28 GDPR requires a contract governing that processing and that you use only processors offering sufficient guarantees. In practice: a data processing agreement. Business plans typically make one available and consumer plans generally do not, but making it available is not the same as having concluded it — that part is yours.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Eine Rechtsgrundlage ist notwendig und für sich genommen nicht ausreichend. Die Grundsätze des Art. 5 gelten weiter, besondere Kategorien personenbezogener Daten — Gesundheit, biometrische Daten, Gewerkschaftszugehörigkeit und die übrigen — brauchen zusätzlich einen Erlaubnistatbestand nach Art. 9, und der Einsatz eines externen Anbieters verlangt zusätzlich die Auftragsverarbeitung weiter unten.",
        "Verarbeitet der Anbieter die Daten weisungsgebunden für dich, ist er Auftragsverarbeiter. Art. 28 DSGVO verlangt dann einen Vertrag über diese Verarbeitung und dass du nur Auftragsverarbeiter einsetzt, die hinreichende Garantien bieten. Praktisch heißt das: ein Auftragsverarbeitungsvertrag. Business-Tarife machen ihn üblicherweise verfügbar, Privatkundentarife in der Regel nicht — verfügbar zu machen heißt aber nicht, ihn abgeschlossen zu haben; das bleibt deine Aufgabe.",
