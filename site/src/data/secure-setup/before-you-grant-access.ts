  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Rotate the credentials that ended up in a chat: passwords, API keys, access tokens, session cookies, private keys, recovery codes, connection strings. Do not guess whether you pasted one — chat history, shell history and a secret scanner over the repository answer it in a few minutes, and that beats a memory test.",
